...
@Test
    public void addToWishList (){
        ...
        driver.findElement(By.cssSelector("body > div > div.page > div.main-container.col2-left-layout > div > div.col-left.sidebar.col-left-first > div > div.block-content > ul > li:nth-child(8) > a"));
        driver.findElement(By.id("search")).sendKeys("LAFAYETTE CONVERTIBLE DRESS");
